...
// awiudhao doauwdhoahwod
String movementsMade[52];
int arrypointer = 0;
...
void loop() {
  ...
  if(currentMillis - previousMillis > interval) { 
    ...
    if (buttonState == LOW && lastButtonState == HIGH) {
      ...
      int treshhold = 28;
      int currentDistence = GetDistance("Forward");
      ...
      for(int i = 0; i < 3; i++) {
        ...
        if (currentDistence == -1) {
          currentDistence = GetDistance("Forward");
        }

        if (currentDistence >= treshhold) {
          moveToPreffertPosistion("Forward", (currentDistence * 2) + 100);
        }
        ...
        if (currentDistence >= treshhold) {
          moveToPreffertPosistion("Left", (currentDistence * 2) + 100);
        }
        ...
        if (currentDistence >= treshhold) {
          moveToPreffertPosistion("Right", (currentDistence * 2) + 100);
        }
      }
